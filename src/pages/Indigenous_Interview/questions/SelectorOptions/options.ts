...
export const etniasNewOptions = {
  ...
  boe: "Boe",
  borari: "Borari",
  canela_apanyekra: "Canela Apanyekrá",
  memortumre: "Memortumré",
  chiquitano: "Chiquitano",
  matetamae: "Matetamãe",
  daw: "Daw",
  jamamadi: "Jamamadi",
  desana: "Desana",
  djeoromitxi: "Djeoromitxí",
  enawene_nawe: "Enawenê-nawê",
  fulnio: "Fulni-ô",
  galibi_ka: "Galibi Ka",
  galibi_marworno: "Galibi-Marworno",
  gamela: "Gamela",
  akratikateje: "Akratikatêjê",
  gaviao_kykateje: "Gavião Kykatejê",
  parkateje: "Parkatejê",
  pykopcateje: "Pykopcatejê",
  guajajara: "Guajajara",
  guarani: "Guarani",
  guato: "Guató",
  ...
  jaraqui: "Jaraqui",
  jarawara: "Jarawara",
  itya_mahadu: "Itya Mahãdu",
  jenipapo_kaninde: "Jenipapo-Kanindé",
  kagwaniwa: "Kagwaniwa",
  jiripanco: "Jiripancó",
  juma: "Juma",
  kaapor: "Ka'apor",
  ...
  karapoto: "Karapotó",
  ahe: "Ahé",
  karipuna_do: "Karipuna do",
  kariri_xoko: "Kariri-Xokó",
  yjxa: "Yjxa",
  itarap: "I´târap",
  kassupa: "Kassupá",
  katuwena: "Katuwena",
  katukina_do: "Katukina do",
  katukina_pano: "Katukina Pano",
  katxuyana: "Katxuyana",
  kawaiwete: "Kawaiwete",
  kaxarari: "Kaxarari",
  kaxixo: "Kaxixó",
  ...
  kotiria: "Kotiria",
  mehin: "Mehin",
  kraho_kanela: "Krahô-Kanela",
  borum: "Borum",
  krenye: "Krenyê",
  kricatije: "Kricatijê",
  kubeo: "Kubeo",
  ipatse_otomo: "Ipatse ótomo",
  towa_panka: "Towa Panka",
  madiha: "Madiha",
  kulina_pano: "Kulina Pano",
  kuruaya: "Kuruaya",
  kwaza: "Kwazá",
  pemon: "Pemon",
  makuna: "Makuna",
  ...
  matses: "Matsés",
  tikmuun: "Tikmu´un",
  mebengokre: "Mebengôkre",
  mehinako: "Mehinako",
  myky: "Myky",
  migueleno: "Migueleno",
  miranha: "Miranha",
  mirity_tapuya: "Mirity-tapuya",
};
